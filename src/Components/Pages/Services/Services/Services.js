            ...
            <div>
                ...
                <div className='grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 gap-10 p-16'>
                    <div className='bg-white rounded-lg text-black'>
                        <h1 className='uppercase text-center font-bold py-4'>Body building</h1>
                    ...
                    <div className='bg-white rounded-lg shadow-2xl  text-black'>
                        <h1 className='uppercase text-center font-bold py-4'>Cardio Work</h1>
                    ...
                    <div className='bg-white rounded-lg text-black'>
                        <h1 className='uppercase text-center font-bold py-4'>Dev Muscles</h1>
                    ...
                    <div className='bg-white rounded-lg text-black'>
                        <h1 className='uppercase text-center font-bold py-4'>Dynamo Fitness</h1>
