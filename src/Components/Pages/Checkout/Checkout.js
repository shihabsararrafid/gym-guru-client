    ...
    return (
        <div className=''>
            ...
            <div className='mx-auto w-full lg:w-[30%] md:w-[79%] mb-14'>
                ...
                <p className='font-bold text-lg text-violet-600'>Then feel free to have a free trial for 7 days.</p><button onClick={() => navigate('/confirmation')} className='text-center block   w-[90%] ] mx-auto  my-6 text-lg py-4 border-[1px] font-semibold border-black hover:text-[#6C05F6] hover:border-[#6C05F6] bg-white text-black rounded-full'>CONFIRM FREE TRIAL<FontAwesomeIcon icon={faArrowRight}></FontAwesomeIcon></button>
            </div>
        </div>
    );
};
